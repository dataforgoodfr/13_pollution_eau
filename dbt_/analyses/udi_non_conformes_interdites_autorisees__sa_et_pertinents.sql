...
--
-- VARIATION : périmètre restreint aux substances actives + métabolites pertinents
-- (les métabolites non pertinents sont exclus). Voir la variation
-- udi_non_conformes_interdites_autorisees__tous_pesticides.sql pour le périmètre complet.
--
...
last_pvl AS (
    ...
    WHERE
        ...
        -- Périmètre de cette variation : substances actives + métabolites pertinents.
        -- (Les métabolites non pertinents sont exclus.)
        AND (
