...
WHERE
    (
        cdreseau = '051000769'
        AND dernier_prel_datetime = TIMESTAMP '2025-03-31 13:58:00'
        AND resultat != 'non_quantifie'
    )
    OR
    (
        cdreseau = '030000509'
        AND dernier_prel_datetime = TIMESTAMP '2025-03-31 11:56:00'
        AND resultat != 'inf_limite_qualite'
    )
    OR
    (
        cdreseau = '029000947'
        AND dernier_prel_datetime = TIMESTAMP '2025-03-31 11:00:00'
        AND resultat != 'sup_limite_qualite'
    )
    OR
    (
        cdreseau = '060001302'
        AND dernier_prel_datetime = TIMESTAMP '2024-12-19 08:29:00'
