...
type PollutionZoneDetailPanelProps = {
  period: string;
  category: string;
...
export default function PollutionZoneDetailPanel({
  period,
  category,
  displayMode,
  selectedZoneData,
              ...
              {category === "pesticide" ? (
                ...
                <div className="space-y-3">
                  {Object.entries(
                    ...
                    const isCollapsed = collapsedSections[groupKey] === true;
  ...
  return (
    <div className="h-full flex flex-col relative">
      ...
      <div className="bg-white p-4 py-8 flex flex-col gap-2 rounded-t-lg flex-1 overflow-y-auto text-sm space-y-2">
        {renderContent()}
      </div>
    </div>
  );
