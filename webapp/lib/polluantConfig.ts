export interface IPollutantCategory {
  id: string;
  shortName: string;
  longName: string;
  subtitle: string;
...
export const POLLUTANT_CATEGORIES: IPollutantCategory[] = [
  {
    id: "tous-polluants",
...
export function getCategoryById(id: string): IPollutantCategory | undefined {
