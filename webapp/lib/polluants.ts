...
export const config: Config = {
  categoriesDisponibles: [

    {
      ...
      desactive: false,
      affichageBloc: true,
      description: "Ensemble des substances chimiques et biologiques pouvant contaminer l'eau, l'air et les sols.",
      risquesSante: "Dépend du polluant : effets cancérigènes, neurotoxiques, perturbateurs endocriniens, maladies chroniques, etc.",
      ...
      resultats: {
        ...
        limite_qualite: {
          label: "Au moins un paramètre au-dessus de la limite de qualité (norme ou recommandation)",
          couleur: "#FBBD6C",
          couleurFond: "#FBBD6C",
          picto: "warning"
        },
        limite_sanitaire: {
          label: "Au moins un paramètre au-dessus de la limite sanitaire (norme ou recommandation)",
          couleur: "#FB726C",
          couleurFond: "#FB726C",
          picto: "red cross"
        }
    ...
    },
    {
      ...
      desactive: false,
      affichageBloc: true,
      description: "Polluants éternels, utilisés dans l'industrie pour leurs propriétés antiadhésives et imperméables.",
      risquesSante: "Perturbateurs endocriniens, cancers, toxicité hépatique et immunitaire.",
      regulation: "Réglementation en cours d'évolution, restriction progressive en Europe.",
      sourcesExposition: "Ustensiles de cuisine, emballages alimentaires, eau potable.",
      resultats: {
        ...
        somme_20pfas_inf_0_1_et_4pfas_sup_0_02: {
          label: "Concentration des PFOA, PFOS, PFNA, PFHxS supérieure à la recommandation (0.02 µg/L)",
          couleur: "#EFE765",
          couleurFond: "#EFE765",
          picto: null
        },
        somme_20pfas_sup_0_1: {
          label: "Concentration totale en PFAS supérieure à la recommandation (>0,1 µg/L)",
          couleur: "#FBBD6C",
          couleurFond: "#FBBD6C",
          picto: null
        },
    ...
    },
    {
      ...
      desactive: false,
      affichageBloc: true,
      description: "Substances chimiques utilisées pour lutter contre les nuisibles agricoles.",
      risquesSante: "Cancers, troubles neurologiques, perturbations endocriniennes, toxicité aiguë.",
      regulation: "LMR (Limites Maximales de Résidus), règlement (CE) n°1107/2009.",
      sourcesExposition: "Agriculture, consommation de produits traités, eau potable.",
      resultats: {
        aucun_dépassement: {
          label: "Aucun dépassement des valeurs seuils",
          couleur: "#B4E681",
      ...
      enfants: [
        {
          ...
          desactive: false,
          affichageBloc: false,
          description: "Molécules ayant un effet biocide contre les organismes nuisibles.",
          risquesSante: "Toxicité variable : certains sont cancérigènes ou reprotoxiques.",
          regulation: "Autorisation par l'ANSES, encadrement par l'UE.",
          sourcesExposition: "Pulvérisation agricole, résidus dans l'eau et les aliments.",
          sousCategories: true,
          resultats: {
            aucun_parametre_quantifie: {
              label: "Aucun paramètre quantifié",
            ...
            limite_qualite: {
              label: "Au moins un paramètre quantifié mais aucun dépassement des valeurs seuils",
              couleur: "#B4E681",
              couleurFond: "#B4E681",
              picto: null
            },
        ...
        },
        {
          ...
          risquesSante: "Moins étudiés que les substances actives, certains sont toxiques.",
          regulation: "Réglementation récente : seuils pour certains métabolites en eau potable.",
          sourcesExposition: "Dégradation dans l'eau et les sols, consommation d'eau potable.",
          sousCategories: false,
          resultats: {
            aucun_dépassement: {
              label: "Aucun dépassement des valeurs seuils",
          ...
          enfants: [
            {
              ...
              resultats: {
                ...
                limite_qualite: {
                  label: "Paramètre quantifié mais en dessous de la limite de qualité (norme ou recommandation)",
                  couleur: "#B4E681",
                  couleurFond: "#B4E681",
                  picto: null
                },
                ...
                limite_sanitaire: {
                  label: "Paramètre quantifié au-dessus de la limite sanitaire (norme ou recommandation)",
                  couleur: "#FB726C",
                  couleurFond: "#FB726C",
                  picto: "red cross"
                }
            ...
            },
            {
              ...
              desactive: false,
              affichageBloc: true,
              description: "Métabolite de la chloridazone, herbicide utilisé pour les betteraves.",
              ...
              resultats: {
                ...
                limite_qualite: {
                  label: "Paramètre quantifié au-dessus de la limite de qualité (norme ou recommandation)",
                  couleur: "#FBBD6C",
                  couleurFond: "#FBBD6C",
                  picto: null
                },
    ...
    },
    {
      ...
      desactive: false,
      affichageBloc: true,
      description: "Résidus azotés provenant des engrais et des déchets organiques.",
      risquesSante: "Méthémoglobinémie, risque de cancer gastro-intestinal.",
      regulation: "Limite de 50 mg/L pour les nitrates, 0,5 mg/L pour les nitrites en eau potable.",
      sourcesExposition: "Agriculture intensive, effluents industriels et domestiques.",
      resultats: {
        conforme: {
    ...
    },
    {
      ...
      risquesSante: "Variable selon la substance, risques cancérigènes et toxiques.",
      regulation: "Encadrement par le Code de l'environnement et les normes REACH.",
      sourcesExposition: "Déchets industriels, effluents rejetés dans l'environnement.",
      enfants: [
        {
          id: "1-4-dioxane",
          ...
          sourcesExposition: "Industries pharmaceutiques et plastiques, eau contaminée.",
          sousCategories: true,
          resultats: {
            parametre_non_recheche: {
              label: "Paramètre non recherché",
            ...
            limite_qualite: {
              label: "Paramètre quantifié mais en concentration inférieure à la limite sanitaire (norme ou recommandation)",
              couleur: "#B4E681",
              couleurFond: "#B4E681",
              picto: null
            },
            limite_sanitaire: {
              label: "Paramètre quantifié en concentration supérieure à la limite sanitaire (norme ou recommandation)",
              couleur: "#FB726C",
              couleurFond: "#FB726C",
              picto: "red cross"
            }
    ...
    },
    {
      ...
      desactive: true,
      affichageBloc: true,
      description: "Éléments toxiques présents naturellement ou issus de l'activité humaine.",
      risquesSante: "Cancers, atteintes neurologiques, troubles rénaux.",
      regulation: "Réglementation stricte selon le métal (Plomb, Mercure, Cadmium, etc.).",
      sourcesExposition: "Pollution industrielle, anciennes canalisations, alimentation.",
      resultats: {
        aucun_dépassement: {
          label: "Aucun dépassement des valeurs seuils",
          couleur: "#B4E681",
      ...
      enfants: [
        ...
        },
        {
          ...
          risquesSante: "Neurotoxique, saturnisme, atteintes rénales et cardiovasculaires.",
          regulation: "Interdit dans l'essence et les peintures, limite de 10 µg/L en eau potable.",
          sourcesExposition: "Vieilles canalisations, pollution industrielle, sol contaminé.",
          sousCategories: false,
          resultats: {
            aucun_parametre_quantifie: {
              label: "Aucun paramètre quantifié",
